...
import { getComments, getComment} from '../mock/comments.js';
...
const createCommentsTemplate = () => {
  `<li class="film-details__comment" >
    <span class="film-details__comment-emoji alt="emoji-${getComment.emotions}">
      <img src="./images/emoji/${getComment.emotions}.png" width="55" height="55" alt="emoji-smile">
    </span>
    <div>
      <p class="film-details__comment-text">${getComment.comment}</p>
      <p class="film-details__comment-info">
        <span class="film-details__comment-author">${getComment.author}</span>
        <span class="film-details__comment-day">${(getComment.date)}</span>
        <button class="film-details__comment-delete">Delete</button>
      </p>
    </div>
  </li>`};

const createFilmInfoPopupTemplate = (comments,film = []) => {
  ...
  const popupComments = getComment;
...
export default class FilmInfoPopupView {
  ...
  get template() {
    return createFilmInfoPopupTemplate(this.#film);
  }
